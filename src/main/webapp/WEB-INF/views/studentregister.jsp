...
<div class="p-3 mb-2 bg-primary text-white"  style="text-align:center;"><h3>Register Student!</h3></div>
<div class="container">
					...
					<form action="register" method="post">
						...
						<div class="form-group">
							<label>Mobile-number</label> <input type="tel"
								title="input 10 digit mobile number, Don't put +91" name="mobileNumber" class="form-control" placeholder="" pattern="[0-9]{10}"required>
						</div>
						<!-- form-group end.// -->
						<!-- form-row end.// -->
						<div class="form-group">
						...
						<div class="form-group">
							<label>University</label> <input type="text"
								name="universityName" class="form-control" placeholder="" required>
						</div>
						<!-- form-group end.// -->
