...
<body>
	...
	<div class="list-group">
		<h1>
			<label style="color: green; position: relative; left: 50%;">Librarians
			</label>
		</h1>
		...
		<c:forEach begin="0" end="${qresult.size()}" var="q"
			...
			<div class="card border border-success">
				<h5 class="card-header   bg-info text-white">${q.name}</h5>
				<div class="card-body">
					<h5 class="card-title">
						<strong>Address: ${q.address}</strong><br> <strong>Password
						</strong>${q.password}
					</h5>
					<h5 class="card-title">
					...
					<div>
						...
						<form action="removelibrarian" method="GET">
						...
						<form action="librarian/updateprofile" method="GET">
							<input type="hidden" id="librarianid" name="id"
								value="${q.email }">
